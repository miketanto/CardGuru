...
You are playing **Mono-Green Landfall** (G). Your 60:

- Forest x15
- Badgermole Cub x4
- Earthbender Ascension x4
- Escape Tunnel x4
- Esper Origins x4
- Fabled Passage x4
- Icetill Explorer x4
- Llanowar Elves x4
- Mightform Harmonizer x4
- Mossborn Hydra x4
- Sazh's Chocobo x4
- Sapling Nursery x3
- Surrak, Elusive Hunter x2

The opponent is playing **Mono-Green Landfall** (G):
