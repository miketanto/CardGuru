...
**Write your answer to `../answers/t3-bestblock-010.txt`** and nothing else: the JSON
...
your battlefield:
  ...
  - Foot Soldiers {3}{W} 2/4 — Creature — Human Soldier
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Dromoka Warrior {1}{W} 3/1 — Creature — Human Warrior
