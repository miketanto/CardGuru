...
**Write your answer to `../answers/t3-bestblock-024.txt`** and nothing else: the JSON
...
your battlefield:
  - Sanctuary Cat {W} 1/2 — Creature — Cat
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Incurable Ogre {3}{R} 5/1 — Creature — Ogre Mutant
