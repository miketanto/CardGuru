...
**Write your answer to `../answers/t3-bestblock-018.txt`** and nothing else: the JSON
...
your battlefield:
  ...
  - Blanchwood Treefolk {4}{G} 4/5 — Creature — Treefolk
  - Lumengrid Warden {1}{U} 1/3 — Creature — Human Wizard
  - Bonebreaker Giant {4}{R} 4/4 — Creature — Giant
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Maritime Guard {1}{U} 1/3 — Creature — Merfolk Soldier
