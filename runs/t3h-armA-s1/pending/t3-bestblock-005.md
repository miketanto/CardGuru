...
**Write your answer to `../answers/t3-bestblock-005.txt`** and nothing else: the JSON
...
your battlefield:
  ...
  - Centaur Courser {2}{G} 3/3 — Creature — Centaur Warrior
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Riot Devils {2}{R} 2/3 — Creature — Devil
