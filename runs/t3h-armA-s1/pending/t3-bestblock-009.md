...
**Write your answer to `../answers/t3-bestblock-009.txt`** and nothing else: the JSON
...
your battlefield:
  - Catacomb Crocodile {4}{B} 3/7 — Creature — Crocodile
  - Merfolk of the Pearl Trident {U} 1/1 — Creature — Merfolk
  - Dwarven Trader {R} 1/1 — Creature — Dwarf
