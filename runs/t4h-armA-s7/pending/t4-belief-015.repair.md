...
**Write your answer to `../answers/t4-belief-015.txt`** and nothing else: the JSON
...
your battlefield:
  - Cliffhaven Sell-Sword {1}{W} 3/1 — Creature — Kor Warrior
  - Swab Goblin {1}{R} 2/2 — Creature — Goblin Pirate
...
Your line failed validation with:
    ...
    invalid line: actions[2]: bad phase 'COMBAT'
