...
**Write your answer to `../answers/t2-face-not-decoy-028.txt`** and nothing else: the JSON
...
your battlefield:
  - Colossodon Yearling {2}{G} 2/4 — Creature — Beast
  - Ironroot Treefolk {4}{G} 3/5 — Creature — Treefolk
  - Goblin Cavaliers {2}{R} 3/2 — Creature — Goblin
