...
**Write your answer to `../answers/t2-face-not-decoy-007.txt`** and nothing else: the JSON
...
your battlefield:
  - Jibbirik Omnivore {1}{G} 3/2 — Creature — Beast
  - Pensive Minotaur {2}{R} 2/3 — Creature — Minotaur Warrior
...
- opponent at 10: a full attack alone leaves them at 5
