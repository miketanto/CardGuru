...
**Write your answer to `../answers/t2-right-burn-011.txt`** and nothing else: the JSON
...
your battlefield:
  - Goblin Piker {1}{R} 2/1 — Creature — Goblin Warrior
  - Border Guard {2}{W} 1/4 — Creature — Human Soldier
...
- your full attack: 4 combat damage (opponent has no untapped creatures; nothing can block)
- opponent at 7: a full attack alone leaves them at 3
