...
**Write your answer to `../answers/t2-creature-only-012.txt`** and nothing else: the JSON
...
your battlefield:
  - Felhide Minotaur {2}{B} 2/3 — Creature — Minotaur
  - Regathan Firecat {2}{R} 4/1 — Creature — Elemental Cat
