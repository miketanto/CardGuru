...
**Write your answer to `../answers/t2-right-burn-029.txt`** and nothing else: the JSON
...
your battlefield:
  - Regal Unicorn {2}{W} 2/3 — Creature — Unicorn
  - Gloom Pangolin {2}{B} 1/5 — Creature — Nightmare Pangolin
  - Armored Wolf-Rider {3}{G}{W} 4/6 — Creature — Elf Knight
...
- your full attack: 7 combat damage (opponent has no untapped creatures; nothing can block)
- opponent at 10: a full attack alone leaves them at 3
- your untapped lands: 2
- Shock ({R}): 2 damage, may target a player; castable now
- Incinerate ({1}{R}): 3 damage, may target a player; castable now
