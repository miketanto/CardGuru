...
**Write your answer to `../answers/t2-creature-only-018.txt`** and nothing else: the JSON
...
your battlefield:
  ...
  - Dutiful Servants {3}{W} 2/5 — Creature — Zombie
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Enormous Baloth {6}{G} 7/7 — Creature — Beast (TAPPED)
...
- opponent at 8: a full attack alone leaves them at 2
