...
**Write your answer to `../answers/t2-right-burn-017.txt`** and nothing else: the JSON
...
your battlefield:
  - Alpine Grizzly {2}{G} 4/2 — Creature — Bear
  - Scathe Zombies {2}{B} 2/2 — Creature — Zombie
  - Obsidian Giant {4}{R} 4/4 — Creature — Giant
...
- your full attack: 10 combat damage (opponent has no untapped creatures; nothing can block)
- opponent at 13: a full attack alone leaves them at 3
