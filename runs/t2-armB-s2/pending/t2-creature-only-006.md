...
**Write your answer to `../answers/t2-creature-only-006.txt`** and nothing else: the JSON
...
your battlefield:
  - Order of the Sacred Bell {3}{G} 4/3 — Creature — Human Monk
...
- opponent at 12: a full attack alone leaves them at 3
