...
**Write your answer to `../answers/t2-creature-only-003.txt`** and nothing else: the JSON
...
your battlefield:
  - Nessian Courser {2}{G} 3/3 — Creature — Centaur Warrior
