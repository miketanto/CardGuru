...
**Write your answer to `../answers/t2-creature-only-021.txt`** and nothing else: the JSON
...
your battlefield:
  - Cyclops of One-Eyed Pass {2}{R}{R} 5/2 — Creature — Cyclops
  - Rowan Treefolk {3}{G} 3/4 — Creature — Treefolk
...
- Lightning Strike ({1}{R}): 3 damage, may target a player; castable now
