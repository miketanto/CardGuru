...
**Write your answer to `../answers/t2-right-burn-008.txt`** and nothing else: the JSON
...
your battlefield:
  - Armored Warhorse {W}{W} 2/3 — Creature — Horse
  - Bear Cub {1}{G} 2/2 — Creature — Bear
  - Minotaur Warrior {2}{R} 2/3 — Creature — Minotaur Warrior
