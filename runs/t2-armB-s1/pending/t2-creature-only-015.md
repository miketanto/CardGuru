...
**Write your answer to `../answers/t2-creature-only-015.txt`** and nothing else: the JSON
...
your battlefield:
  - Ageless Guardian {1}{W} 1/4 — Creature — Spirit Soldier
  - Fomori Nomad {4}{R} 4/4 — Creature — Nomad Giant
...
- your full attack: 5 combat damage (opponent has no untapped creatures; nothing can block)
- opponent at 8: a full attack alone leaves them at 3
- your untapped lands: 2
- Searing Spear ({1}{R}): 3 damage, may target a player; castable now
- Lava Coil ({1}{R}): 4 damage, targets creatures ONLY — cannot be aimed at a player; castable now
- total costs 4 > 2 untapped lands: you cannot cast everything
