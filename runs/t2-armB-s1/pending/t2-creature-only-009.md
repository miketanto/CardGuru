...
**Write your answer to `../answers/t2-creature-only-009.txt`** and nothing else: the JSON
...
your battlefield:
  ...
  - Ancient Carp {4}{U} 2/5 — Creature — Fish
  - Queen's Bay Soldier {1}{B} 2/2 — Creature — Vampire Soldier
  - Mountain — Basic Land — Mountain
      text: ({T}: Add {R}.)
your hand:
  - Lightning Bolt {R} — Instant
      text: Lightning Bolt deals 3 damage to any target.
  - Flame Slash {R} — Sorcery
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Craw Wurm {4}{G}{G} 6/4 — Creature — Wurm (TAPPED)

COMPUTED (facts derived by the engine tooling — not advice):
- your full attack: 6 combat damage (opponent has no untapped creatures; nothing can block)
- opponent at 9: a full attack alone leaves them at 3
- your untapped lands: 1
- Lightning Bolt ({R}): 3 damage, may target a player; castable now
- Flame Slash ({R}): 4 damage, targets creatures ONLY — cannot be aimed at a player; castable now
- total costs 2 > 1 untapped lands: you cannot cast everything
