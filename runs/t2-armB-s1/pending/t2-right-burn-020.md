...
**Write your answer to `../answers/t2-right-burn-020.txt`** and nothing else: the JSON
...
your battlefield:
  - Devoted Hero {W} 1/2 — Creature — Elf Soldier
  - Onakke Ogre {2}{R} 4/2 — Creature — Ogre Warrior
  - Curio Vendor {1}{U} 2/1 — Creature — Vedalken
