...
**Write your answer to `../answers/t2-face-not-decoy-001.txt`** and nothing else: the JSON
...
your battlefield:
  - Minotaur Abomination {4}{B}{B} 4/6 — Creature — Zombie Minotaur
  - Shatterskull Giant {2}{R}{R} 4/3 — Creature — Giant Warrior
...
- your full attack: 11 combat damage (opponent has no untapped creatures; nothing can block)
- opponent at 17: a full attack alone leaves them at 6
- your untapped lands: 4
