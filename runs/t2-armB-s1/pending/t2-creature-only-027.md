...
**Write your answer to `../answers/t2-creature-only-027.txt`** and nothing else: the JSON
...
your battlefield:
  - Fortress Crab {3}{U} 1/6 — Creature — Crab
  - Great-Horn Krushok {4}{W} 3/5 — Creature — Beast
...
- opponent at 6: a full attack alone leaves them at 2
