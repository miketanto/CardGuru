...
**Write your answer to `../answers/t1-lethal-024.txt`** and nothing else: the JSON
...
your battlefield:
  ...
  - Dakmor Scorpion {1}{B} 2/1 — Creature — Scorpion
  - Gorilla Warrior {2}{G} 3/2 — Creature — Ape Warrior
