...
**Write your answer to `../answers/t1-lethal-011.txt`** and nothing else: the JSON
...
your battlefield:
  - Redwood Treefolk {4}{G} 3/6 — Creature — Treefolk
  - Plated Seastrider {U}{U} 1/4 — Creature — Beast
  - Bastion Enforcer {2}{W} 3/2 — Creature — Dwarf Soldier
your hand: (empty)
...
their battlefield:
  ...
  - Coral Merfolk {1}{U} 2/1 — Creature — Merfolk (TAPPED)
