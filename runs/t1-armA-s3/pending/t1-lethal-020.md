...
**Write your answer to `../answers/t1-lethal-020.txt`** and nothing else: the JSON
...
your battlefield:
  ...
  - Loxodon Wayfarer {2}{W} 1/5 — Creature — Elephant Monk
  - Cabal Evangel {1}{B} 2/2 — Creature — Human Cleric
