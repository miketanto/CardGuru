...
**Write your answer to `../answers/t4-belief-008.txt`** and nothing else: the JSON
...
your battlefield:
  - Moriok Reaver {2}{B} 3/2 — Creature — Human Warrior
  - Starfleet Crew {1}{W} 2/3 — Creature — Officer
  - Kalonian Tusker {G}{G} 3/3 — Creature — Beast
...
Your line failed validation with:
    ...
    invalid line: actions[3]: bad phase 'COMBAT'
