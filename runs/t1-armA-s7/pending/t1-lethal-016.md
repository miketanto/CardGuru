...
**Write your answer to `../answers/t1-lethal-016.txt`** and nothing else: the JSON
...
their battlefield:
  ...
  - Sea Scryer {1}{U} 1/1 — Creature — Merfolk Wizard (TAPPED)
      text: {T}: Add {C}. {1}, {T}: Add {U}.
