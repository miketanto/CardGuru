...
**Write your answer to `../answers/t4-belief-005.txt`** and nothing else: the JSON
...
your battlefield:
  - Python {1}{B}{B} 3/2 — Creature — Snake
  - Russet Wolves {3}{R} 3/3 — Creature — Wolf
