...
**Write your answer to `../answers/t4-belief-020.txt`** and nothing else: the JSON
...
your battlefield:
  - Swordwise Centaur {G}{G} 3/2 — Creature — Centaur Warrior
  - Gorilla Warrior {2}{G} 3/2 — Creature — Ape Warrior
  - Falkenrath Reaver {1}{R} 2/2 — Creature — Vampire
