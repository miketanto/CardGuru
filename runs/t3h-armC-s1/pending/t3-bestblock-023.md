...
**Write your answer to `../answers/t3-bestblock-023.txt`** and nothing else: the JSON
...
your battlefield:
  - Muck Rats {B} 1/1 — Creature — Rat
  - Defense Force Aggressor {R} 2/1 — Creature — Klingon Warrior
  - Merfolk of the Pearl Trident {U} 1/1 — Creature — Merfolk
