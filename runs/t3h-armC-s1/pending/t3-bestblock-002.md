...
**Write your answer to `../answers/t3-bestblock-002.txt`** and nothing else: the JSON
...
your battlefield:
  - Capital Guard {1}{R} 2/2 — Creature — Human Soldier
  - Armored Cancrix {4}{U} 2/5 — Creature — Crab
  - Felhide Minotaur {2}{B} 2/3 — Creature — Minotaur
  - Gutter Skulk {1}{B} 2/2 — Creature — Zombie Rat
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Runeclaw Bear {1}{G} 2/2 — Creature — Bear
