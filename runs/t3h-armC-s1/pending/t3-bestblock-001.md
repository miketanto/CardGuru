...
**Write your answer to `../answers/t3-bestblock-001.txt`** and nothing else: the JSON
...
your battlefield:
  - Giant Cockroach {3}{B} 4/2 — Creature — Insect
  - Great Hart {3}{W} 2/4 — Creature — Elk
  - Fresh Volunteers {1}{W} 2/2 — Creature — Human Rebel
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Scarwood Goblins {R}{G} 2/2 — Creature — Goblin
