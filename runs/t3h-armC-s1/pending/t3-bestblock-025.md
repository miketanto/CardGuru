...
**Write your answer to `../answers/t3-bestblock-025.txt`** and nothing else: the JSON
...
your battlefield:
  - Lizard Warrior {3}{R} 4/2 — Creature — Lizard Warrior
  - Canyon Minotaur {3}{R} 3/3 — Creature — Minotaur Warrior
