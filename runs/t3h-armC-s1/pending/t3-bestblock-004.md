...
**Write your answer to `../answers/t3-bestblock-004.txt`** and nothing else: the JSON
...
your battlefield:
  - Dross Crocodile {3}{B} 5/1 — Creature — Zombie Crocodile
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Loxodon Line Breaker {2}{W} 3/2 — Creature — Elephant Soldier
