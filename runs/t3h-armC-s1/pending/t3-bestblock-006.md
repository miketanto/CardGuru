...
**Write your answer to `../answers/t3-bestblock-006.txt`** and nothing else: the JSON
...
your battlefield:
  ...
  - Lazotep Behemoth {4}{B} 5/4 — Creature — Zombie Hippo
  - Keepers of the Faith {1}{W}{W} 2/3 — Creature — Human Cleric
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Nether Horror {3}{B} 4/2 — Creature — Horror
