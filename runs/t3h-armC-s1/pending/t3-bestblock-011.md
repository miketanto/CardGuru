...
**Write your answer to `../answers/t3-bestblock-011.txt`** and nothing else: the JSON
...
your battlefield:
  - Femeref Scouts {2}{W} 1/4 — Creature — Human Scout
  - Pheres-Band Centaurs {4}{G} 3/7 — Creature — Centaur Warrior
  - Giant Octopus {3}{U} 3/3 — Creature — Octopus
...
their battlefield:
  ...
  - Island — Basic Land — Island (TAPPED)
      text: ({T}: Add {U}.)
  - Golgari Longlegs {3}{B/G}{B/G} 5/4 — Creature — Insect
