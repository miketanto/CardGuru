...
- 2026-09-14 (P4 DONE): rl/probes/token_probe.py + run_p4.sh; rl/artifacts/v7/9/token_probe_summary.txt. Balanced accuracy 1.000 for flying/lifelink/any-keyword/P/T buckets on the raw wire row, the builder token and every subject encoder (8,386 battlefield creature rows, 1,825 consults, 16 cards); first strike not testable (0 positives). Reading "preserves" everywhere; the wire row carries the 18 keyword bits explicitly, so the probe reads input fields, not the embedding. Section "9 / P4". Next: P2/P3 recordings (rl/probes/record_p9.sh: driver 7911 up; CP7 on Dimir recorded, 248 consults / 8 games; DIM argmax recording running).
- 2026-09-14 (P2 + P3 DONE): recordings rl/probes/record_p9.sh (driver 7911; CP7 teacher seat 8+24 games -> rec_cp7_dimir{,_b}.jsonl; DIM ck_512 argmax through record_proxy.py 8+24 games -> rec_dim_dimir{,_b}.jsonl; all stopped). P2 (target_probe.py, run_p2.sh): 157 consults with k>=2 creature targets; DIM as recorded P(largest) 0.856 vs chance 0.694, +0.162 [0.100,0.227] size-aware; init +0.225, BC/DIM memoryless +0.282, C1s0/L0 not size-aware and target their own creatures; equal-PT different-text n=6 -> not testable. P3 (instant_speed.py, run_p3.sh): DIM 71/254 = 0.280 [0.228,0.338] vs CP7 14/148 = 0.095 [0.057,0.153]; excluding forced counterspells 15/195 = 0.077 vs 6/136 = 0.044 (overlap); flash creatures 0/103 at instant speed; heuristic timing not readable from the wire (0/295 first reports on the stack); 7d1b W0Base has no instants. Sections "9 / P2", "9 / P3", "Phase 9 verdict" in V7-VALIDATION.md; HANDOFF-V7.md UPDATE + section N. PHASE 9 CLOSED. Nothing running.
