...
public class EpisodeRunner {
    ...
    private EpisodeResult playEpisode(PolicyClient policy, Map<String, Integer> fallbacks,
        ...
        if (agent instanceof CP7TeacherPlayer) {
            ...
            fallbacks.merge("teacherPrioConsults", (int) c7.prioConsults, Integer::sum);
            fallbacks.merge("teacherTgtConsults", (int) c7.tgtConsults, Integer::sum);
            fallbacks.merge("teacherTgtLabelled", (int) c7.tgtLabelled, Integer::sum);
            fallbacks.merge("teacherTgtOutside", (int) c7.tgtOutside, Integer::sum);
            fallbacks.merge("teacherTgtOptional", (int) c7.tgtOptional, Integer::sum);
            fallbacks.merge("teacherTgtPreset", (int) c7.tgtPreset, Integer::sum);
            fallbacks.merge("teacherTgtBudgetSkipped", (int) c7.tgtBudgetSkipped, Integer::sum);
            fallbacks.merge("teacherAtkConsults", (int) c7.atkConsults, Integer::sum);
            fallbacks.merge("teacherAtkExact", (int) c7.atkExact, Integer::sum);
            fallbacks.merge("teacherAtkAlias", (int) c7.atkAlias, Integer::sum);
            fallbacks.merge("teacherAtkMiss", (int) c7.atkMiss, Integer::sum);
            fallbacks.merge("teacherBlkConsults", (int) c7.blkConsults, Integer::sum);
            fallbacks.merge("teacherBlkExact", (int) c7.blkExact, Integer::sum);
            fallbacks.merge("teacherBlkAlias", (int) c7.blkAlias, Integer::sum);
            fallbacks.merge("teacherBlkMiss", (int) c7.blkMiss, Integer::sum);
            fallbacks.merge("teacherJointFallbacks", (int) c7.jointFallbacks, Integer::sum);
            fallbacks.merge("teacherJointMiss", (int) (c7.atkMiss + c7.blkMiss), Integer::sum);
            fallbacks.merge("teacherPrioAlias", (int) c7.prioAlias, Integer::sum);
