...
mkdir -p $S
for pt in start:$LB/rl/artifacts/v7/11/drill/pool/M_D_06400.pt p1024:$LB/rl/artifacts/v7/12/pool/M_D_07424.pt p2048:$LB/rl/artifacts/v7/12/pool/M_D_08448.pt; do
    name=${pt%%:*}; ck=${pt#*:}
